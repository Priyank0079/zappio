...
export default function OrderAgain() {
  ...
  return (
    <div className="pb-4">
      ...
      <div className="px-4 py-3 bg-white border-b border-neutral-200 sticky top-0 z-10 flex items-center gap-3">
        <button
          onClick={() => navigate(-1)}
        ...
        <h1 className="text-base font-bold text-neutral-900">Your Previous Orders</h1>
      </div>
            ...
            <div className="relative w-full max-w-xs mb-4">
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative w-40 h-48 bg-gradient-to-b from-yellow-400 via-yellow-300 to-yellow-500 rounded-b-2xl rounded-t-lg shadow-xl border-2 border-yellow-500/30 flex items-center justify-center">
                  ...
                  {/* Zappio text inside basket */}
                  <div className="relative z-10 text-center px-4">
                    <span className="text-2xl font-extrabold text-neutral-900 tracking-tight drop-shadow-sm">Zappio</span>
